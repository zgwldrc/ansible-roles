...
JAVA_OPT_EXT="-javaagent:{{javaagent_opt}}"
JAVA_OPT="${JAVA_OPT} -server -Xms{{broker_xms}} -Xmx{{broker_xmx}}"
choose_gc_options
JAVA_OPT="${JAVA_OPT} -XX:-OmitStackTraceInFastThrow"
JAVA_OPT="${JAVA_OPT} -XX:+AlwaysPreTouch"
JAVA_OPT="${JAVA_OPT} -XX:MaxDirectMemorySize={{broker_MaxDirectMemorySize}}"
